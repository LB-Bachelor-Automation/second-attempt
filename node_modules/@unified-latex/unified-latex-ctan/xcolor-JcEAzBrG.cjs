...
const fromRgb = ([r, g, b]) => Color([r * 255, g * 255, b * 255], "rgb");
const DVI_PS_NAMES = {
...
const parseCache = {};
function parse(str = "") {
  parseCache[str] = parseCache[str] || unifiedLatexUtilPegjs.XColorPegParser.parse(str);
  return parseCache[str];
}
const CORE_MODELS = /* @__PURE__ */ new Set(["rgb", "cmy", "cmyk", "hsb", "gray"]);
const XColorCoreModelToColor = {
  rgb: ([r, g, b]) => Color([r * 255, g * 255, b * 255], "rgb"),
  cmy: ([c, m, y]) => XColorCoreModelToColor.rgb([1 - c, 1 - m, 1 - y]),
  cmyk: ([c, m, y, k]) => Color([c * 255, m * 255, y * 255, k * 100], "cmyk"),
  hsb: ([h, s, b]) => Color([h * 360, s * 100, b * 100], "hsv"),
  gray: ([v]) => Color([v * 255, v * 255, v * 255], "rgb")
};
...
exports.DVI_PS_NAMES = DVI_PS_NAMES;
exports.PREDEFINED_XCOLOR_COLORS = PREDEFINED_XCOLOR_COLORS;
exports.SVG_NAMES = SVG_NAMES;
exports.X11_NAMES = X11_NAMES;
exports.XColorCoreModelToColor = XColorCoreModelToColor;
exports.computeColor = computeColor;
exports.environments = environments;
exports.macros = macros;
exports.parse = parse;
exports.xcolorColorToHex = xcolorColorToHex;
//# sourceMappingURL=xcolor-JcEAzBrG.cjs.map
